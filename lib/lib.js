...
var Rectangle = function (_Drawable) {
    ...
    function Rectangle(x, y, width, height, rot, opacity, color) {
        _classCallCheck(this, Rectangle);

        var _this = _possibleConstructorReturn(this, (Rectangle.__proto__ || Object.getPrototypeOf(Rectangle)).call(this, x, y, width, height, rot, opacity));
...
var SimpleText = function (_Drawable2) {
    ...
    function SimpleText() {
        ...
        var x = arguments[1];
        var y = arguments[2];
        var width = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 100000;
        var height = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 14;
        ...
        var rot = arguments[7];
        var opacity = arguments[8];

        _classCallCheck(this, SimpleText);

        var _this2 = _possibleConstructorReturn(this, (SimpleText.__proto__ || Object.getPrototypeOf(SimpleText)).call(this, x, y, width, height, rot, opacity));
    ...
    _createClass(SimpleText, [{
        ...
        value: function draw(ctx) {
            ctx.save();
            _get(SimpleText.prototype.__proto__ || Object.getPrototypeOf(SimpleText.prototype), 'draw', this).call(this, ctx);
...
var Sprite = function (_Drawable3) {
    ...
    function Sprite(image, x, y, width, height, rot, opacity) {
        ...
        if (image instanceof Image) {
            ...
            var _this3 = _possibleConstructorReturn(this, (Sprite.__proto__ || Object.getPrototypeOf(Sprite)).call(this, x, y, width || image.naturalWidth, height || image.naturalHeight, rot, opacity));

            _this3.image = image;
            _this3.draw = _this3._imageDraw;
        } else if (image instanceof Sprite.Sheet) {
            var _this3 = _possibleConstructorReturn(this, (Sprite.__proto__ || Object.getPrototypeOf(Sprite)).call(this, x, y, width || image.subimageWidth, height || image.subimageHeight, rot, opacity));

            _this3.spriteSheet = image;
            _this3.subimage = 0;
            _this3.draw = _this3._sheetDraw;
        } else {
    ...
    _createClass(Sprite, [{
        key: '_imageDraw',
        value: function _imageDraw(ctx) {
            ctx.save();
            _get(Sprite.prototype.__proto__ || Object.getPrototypeOf(Sprite.prototype), 'draw', this).call(this, ctx);
            ctx.drawImage(this.image, this.x | 0, this.y | 0, this.width | 0, this.height | 0);
            ctx.restore();
        }
    }, {
        key: '_sheetDraw',
        value: function _sheetDraw(ctx) {
            //draw a SpriteSheet
            ctx.save();
            _get(Sprite.prototype.__proto__ || Object.getPrototypeOf(Sprite.prototype), 'draw', this).call(this, ctx);
...
Sprite.Sheet = function () {
    function _class(image, subimageWidth, subimageHeight, subimageCount) {
...
var SimpleView = function (_View) {
    ...
    function SimpleView() {
        ...
        var backgroundColor = arguments[8];
        var smooth = arguments.length > 9 && arguments[9] !== undefined ? arguments[9] : true;
        ...
        _this4.zoomX = +zoomX;
        _this4.zoomY = +zoomY;
        _this4.smooth = !!smooth;

        _this4.backgroundColor = backgroundColor;
        return _this4;
    }
...
var SceneManager = function () {
    function SceneManager(canvas) {
        var fpscap = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 60;
        ...
        value: function image(src) {
            ...
            temp.onload = function () {
                ...
                if (this.progress == this.total) this._completeEvents.forEach(function (f) {
                    ...
                    return f(_this6.progress, _this6.total);
                });
            }.bind(this);
...
var Input = function () {
    function Input() {
        ...
        window.addEventListener('deviceorientation', function (e) {
            _this8._tiltEvents.forEach(function (o) {
                return o();
            });
            _this8.tilt = {
                abs: e.absolute,
        ...
        el.onmousedown = function (e) {
            e.preventDefault();
            e.target.focus();
            _this8.buttonsDown[e.button] = true;
            _this8._mouseEvents.down.forEach(function (o) {
        ...
        el.onmouseup = function (e) {
            e.preventDefault();
            e.target.focus();
            _this8.buttonsDown[e.button] = false;
            _this8._mouseEvents.up.forEach(function (o) {
                if (o.button != undefined) {
                    if (o.button == e.button) o.func(e.button);
                } else o.func(e.button);
            });
        ...
        el.onmousemove = function (e) {
            _this8._mouseEvents.move.forEach(function (o) {
                return o.func();
            });
            ...
            _this8.mousePos.x = e.clientX - left;
            _this8.mousePos.y = e.clientY - top;
        };

        el.onkeydown = function (e) {
            if (!_this8.keysDown[e.key.toLowerCase()]) {
                e.preventDefault();
                _this8.keysDown[e.key.toLowerCase()] = true;
                _this8._keyEvents.down.forEach(function (o) {
                    if (o.key) {
        ...
        el.onkeyup = function (e) {
            e.preventDefault();
            _this8.keysDown[e.key.toLowerCase()] = false;
            _this8._keyEvents.up.forEach(function (o) {
                if (o.key) {
                    if (o.key == e.key.toLowerCase()) o.func(e.key);
                } else o.func(e.key);
            });
    ...
    _createClass(Input, [{
        ...
        value: function setCursor() {
            ...
            this._el.style.cursor = args.reduce(function (a, c) {
                return a + c + ', ';
            }, "") + "auto";
        }
    }, {
        ...
        key: 'unMouse',
        value: function unMouse(eventName, func) {
            if (!eventName) throw new TypeError("ParameterError: eventName required!");
            if (!func) throw new TypeError("ParameterError: func callback required!");
            if (!this._mouseEvents[eventName]) throw new Error(eventName + " is not a valid event!");

            var find = this._mouseEvents[eventName].findIndex(function (f) {
                return f.func === func;
            });
            if (find === -1) throw new Error("func is not a registered key listener!");
        ...
        key: 'unKey',
        value: function unKey(eventName, func) {
            if (!eventName) throw new TypeError("ParameterError: eventName required!");
            if (!func) throw new TypeError("ParameterError: func callback required!");
            if (!this._keyEvents[eventName]) throw new Error(eventName + " is not a valid event!");

            var find = this._keyEvents[eventName].findIndex(function (f) {
                return f.func === func;
            });
            if (find === -1) throw new Error("func is not a registered key listener!");
        ...
        key: 'onTilt',
        value: function onTilt(func) {
            if (!func) throw new TypeError("ParameterError: func callback required!");
            this._tiltEvents.push(func);
        }
    }, {
        key: 'unTilt',
        value: function unTilt(func) {
            if (!func) throw new TypeError("ParameterError: func callback required!");

            var find = this._tiltEvents.findIndex(function (f) {
                return f.func === func;
            });
            if (find === -1) throw new Error("func is not a registered key listener!");
